...
if __name__ == "__main__":
    ...
    def stack_frames(stacked_frames, preproccesed_frame, is_new_episode):
    ...
    for i in range(100):
        ...
        # print(predict_image) #before predict_image
        ...
        hsv = cv2.cvtColor(predict_image, cv2.COLOR_BGR2HSV)
        ...
        stacked_frames(preprocessed_frame)

        # predicted output
        output = loaded_model.predict_classes(stacked_frames)
    ...
    # memory.add((state, prediction, reward, next_state, done))
    #
    # ### LEARNING PART
